...
peso = float(input('Quantos kg de peixe João pescou hoje? '))
if peso > 50:
    excesso = peso - 50
    multa = excesso * 4
    print(f'João terá que pagar R${multa:.2f} de multa!')
else:
    print(f'Peso dentro do permitido. Não há multa a ser paga.')
